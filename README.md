...
- Input validation (duplicate ID, full list)
...
## 📷 Sample Output
<img width="300" height="477" alt="{97890CFD-9925-4C61-848D-22A43483BD76}" src="https://github.com/user-attachments/assets/52157267-44ad-45e1-a298-1b3ab58907a8" />
---

## 🧠 Concepts Used

- `struct` to store habit data
- Arrays to manage multiple habits
- Functions for modular and clean code
- `while(true)` loop for the menu
- `switch` statement for menu choices
- `for` loops for searching and displaying
- `cin.ignore()` and `getline()` for reading names with spaces
